...
def main() -> int:
    ...
    items = [
        ...
        row("language", "LLM / coding tokens", "mapped", 21,
            "analog is trit ALU + expression parser (21/21); not an observer on FlyWire W",
            "do not seed language on W; splice as invented region at a command bottleneck later"),
