...
| ARC (AI2 science MCQ) | question + choices + key | TED-24 study train, exam val: precision **68.6%** when answered (48/70). TED-25 taught the miss procedures (`reason_proc`): **79/79** correct when answered, **471/570** leftover. | **ingested** |
